...
public class DefaultInputHandler extends InputHandler {
	...
	/**
	 * Adds a key binding to this input handler. The key binding is a list of white
	 * space separated key strokes of the form <i>[modifiers+]key</i> where modifier
	 ...
	 * <i>modifiers</i>+<i>shortcut</i> where <i>modifiers</i> is any combination of
