...
public abstract class TokenMarker {
	...
	/**
	 * Returns if the token marker supports tokens that span multiple lines. If this
	 * is true, the object using this token marker is required to pass all lines in
	 * the document to the <code>markTokens()</code> method (in turn).
	 * <p>
	 ...
	 */
	public int getLineCount() { return length; }

	/**
	 * Returns true if the next line should be repainted. This will return true
	 * after a line has been tokenized that starts a multiline token that continues
	 * onto the next line.
	 */
	...
	/**
	 * The last token in the list. New tokens are added here. This should be set to
	 * null before a new line is to be tokenized.
	 */
	...
	/**
	 * Ensures that the <code>lineInfo</code> array can contain the specified index.
	 * This enlarges it if necessary. No action is taken if the array is large
	 * enough already.
	 * <p>
