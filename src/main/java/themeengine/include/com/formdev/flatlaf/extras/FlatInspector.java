...
package themeengine.include.com.formdev.flatlaf.extras;
...
import themeengine.include.com.formdev.flatlaf.ui.FlatToolTipUI;
	...
	private Component getDeepestComponentAt( Component parent, int x, int y ) {
		...
		if( parent instanceof Container ) {
			for( Component child : ((Container)parent).getComponents() ) {
				...
				if( "themeengine.include.com.formdev.flatlaf.ui.FlatWindowResizer".equals( c.getClass().getName() ) )
					continue;
